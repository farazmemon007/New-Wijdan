                ...
                <div class="row">
                    <div class="col-lg-4 stretched_card">
                        <div class="card bg-card-success">
                            <div class="card-body">
                                <h5 class="card-title text-white">Stock IDs</h5>
                                ...
                                @else
                                    <p class="text-white">No stock data available.</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 stretched_card mt-mob-4">
                        <div class="card bg-card-primary">
                            <div class="card-body">
                                <p class="card_title text-white"><i class="feather ft-activity mr-2"></i> Daily Sales <span
                                        class="pull-right text-bold">20K</span></p>
                            </div>
                        ...
                        <div class="card bg-card-danger">
                            <div class="card-body">
                                <p class="card_title text-white"><i class="feather ft-hard-drive mr-2"></i> Yesterday Sales
                                    <span class="pull-right text-bold">30K</span>
                                </p>
                            </div>
                            <div class="text-center">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p>
                                    ...
                                    contentwill be distracted by the readable content.
                                </p>
                                <div class="float-left">
                                ...
                                <div class="table-responsive">
                                    <table id="dataTable">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Airi Satou</td>
                                                <td><span class="text-warning">●</span> <span class="badge badge-warning">In
                                                        Progress</span></td>
                                                <td>60%</td>
                                            </tr>
                                            <tr>
                                                <td>Angelica Ramos</td>
                                                <td><span class="text-success">●</span> <span
                                                        class="badge badge-success">Completed</span></td>
                                                <td>100%</td>
                                            </tr>
                                            <tr>
                                                <td>Ashton Cox</td>
                                                <td><span class="text-danger">●</span> <span class="badge badge-danger">Not
                                                        Completed</span></td>
                                                <td>75%</td>
                                            </tr>
                                            <tr>
                                                <td>Bradley Greer</td>
                                                <td><span class="text-info">●</span> <span class="badge badge-info">Please
                                                        Check</span></td>
                                                <td>10%</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>Caesar Vance</td>
                                                <td><span class="text-primary">●</span> <span
                                                        class="badge badge-primary">Worked</span></td>
                                                <td>100%</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                                    ...
                                                    <div class="media recent_activity mt-2">
                                                        ...
                                                        <div class="media-body">
                                                            <h6 class="mt-0 mb-1">Jhon Doe
                                                                <small class="font-weight-normal d-block mt-1">18 Jan 2019
                                                                    11:28
                                                                    pm
                                                                </small>
                                                            </h6>
