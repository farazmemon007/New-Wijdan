                ...
                <div class="page-header row">
                    ...
                    <div class="page-btn d-flex justify-content-end col-lg-6">
                        ...
                        <a href="{{ url('vendors-ledger') }}" class="btn btn-sm btn-danger ms-2 mb-2">Ledger</a>
                                        ...
                                        <a href="{{ url('vendor/bilties') }}" class="btn btn-sm btn-danger ms-2 mb-2">builty</a>
           ...
           <input type="hidden" id="vendor_id" name="id">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-2"><input class="form-control" name="opening_balance" id="opening_balance" placeholder="opening balance" required></div>
...
$(document).ready(function () {
    ...
    $('#vendor_id').val('');
    $('#vname').val('');
    $('#opening_balance').val('').prop('readonly', false); // allow edit
    $('#vphone').val('');
    $('#vaddress').val('');
};
...
$('.btn-edit-vendor').click(function () {
    ...
    $('#vname').val(name);
    $('#vphone').val(phone);
    $('#opening_balance').val(balance).prop('readonly', true); // prevent edit
